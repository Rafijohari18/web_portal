...
<section class="section">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="float-right">
          <a href="{{ route('roles.create') }}" class="btn btn-info" data-toggle="tooltip" data-original-title="click to add role"><i class="fas fa-plus"></i> Create</a></div>
        </div>
    ...
    <table class="table table-striped table-md">
      ...
      <tr>
        ...
        <td>
            <a href="{{ route('roles.edit', ['id' => $item['id']]) }}" class="btn icon-btn btn-sm btn-warning" data-toggle="tooltip" data-original-title="click to edit role"><i class="ion-edit"></i></a>
            <a onclick="return confirm('Anda Yakin ? ')" href="{{ route('roles.destroy', ['id' => $item['id']])}}" class="btn icon-btn btn-sm btn-danger" data-toggle="tooltip" data-original-title="click to delete role">
